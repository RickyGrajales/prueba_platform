...
<body>
    <div class="header">
        ...
        <div class="welcome">Alumno P.B.J</div>
    ...
    <div class="container">
        <div class="sidebar">
            <a href="{{ route('estudiantePBJ.editar') }}">Actualizar Datos</a>
        </div>
        <div class="descargas-container">
            <div class="descargas">
                <div>
                    <a href="{{ route('encuesta.ver') }}">
...
Continuación del proyecto, quede con el 
logueo-inicio de sesión del estudiantePBJ.blade.php
ya me inicia sessión sin problema.

-Pendiente de continuar con: 
(Actualizar Datos, Encuesta, Eventos, Boletines, Certificados) 
